  ...
  return (
    <>
        ...
        <div className="flex mt-4 justify-around mx-3">
           ...
           <div className='text-xl text-black font-bold'>Name Of proffesor <p className='font-light'>FacultyId : asj6djjs5_6</p></div>
          
          <div className="lg:flex md:flex flex-row lg:flex-1 ml-8 justify-end font-normal">
           <span className="text-xl text-black mx-[10px] font-bold">Courses : Data Structures</span>
          </div>
        </div>
        </div>
      </div>
