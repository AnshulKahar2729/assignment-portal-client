...
function RecentPosts({ selectedDate }) {
    const today = new Date();
    return (
        <div className='h-[350px] w-full flex flex-col gap-4 text-[#245DE1] text-xl'>
            <div className="selected-date w-full ">
                <h3 className='w-full text-center border-b border-[#245de153] text-2xl'><b>Recent Posts : <br/>{selectedDate ? selectedDate.toDateString() : today.toDateString()}</b></h3>
            </div>
